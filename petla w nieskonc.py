...
wiersze =list[dictionaries.values()]
print(wiersze)
# lista_kolumn =[]
# nowe_wiersze =[]
...
#         lista_do_wierszy = wiersze
#         print(lista_do_wierszy)
#         print("While")
#         while len(set(kolumna)) != len(list) or  len(set(lista_do_wierszy[i])) != len(list): 
#             print(len(set(kolumna)), len(set(lista_do_wierszy[i])), len(set(kolumna)) and len(set(lista_do_wierszy[i])))
